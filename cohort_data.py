...
def sort_by_cohort(filename):
    ...
    for line in datafile:
        line = line.rstrip()
        info = line.split("|")
        if info[4] == "Winter 2016":
            winter_16.append(info[0] + " " + info[1])
        elif info[4] == "Spring 2016":
            spring_16.append(info[0] + " " + info[1])
        elif info[4] == "Summer 2016":
            summer_16.append(info[0] + " " + info[1])
        elif info[4] == "Fall 2015":
            fall_15.append(info[0] + " " + info[1])
        elif info[4] == "G":
            ghosts.append(info[0] + " " + info[1])
...
def hogwarts_by_house(filename):
    ...
    for line in datafile:
        line = line.rstrip()
        info = line.split("|")
        if info[2] == "Gryffindor":
            gryffindor.append(info[1])
        elif info[2] == "Hufflepuff":
            hufflepuff.append(info[1])
        elif info[2] == "Slytherin":
            slytherin.append(info[1])
        elif info[2] == "Ravenclaw":
            ravenclaw.append(info[1])
        elif info[2] == "Dumbledore's Army":
            dumbledores_army.append(info[1])
        else:
            if info[4] == "I":
                instructors.append(info[1])
            elif info [4] == "G":
                ghosts.append(info[1])
